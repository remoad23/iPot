...
namespace iPotAPI.Migrations
{
    public partial class InitialCreatePotDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PlantStateId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    NeedsWater = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "PlantState",
                columns: new[] { "PlantStateId", "AmbientLightIntensity", "LedIntensity", "MoistureValue", "NeedsWater", "SettingsId", "WaterStorage" },
                values: new object[] { 1, 30f, 50f, 5f, false, 1, (byte)50 });
